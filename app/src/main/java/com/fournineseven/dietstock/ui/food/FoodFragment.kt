...
//    fun predict(){
//        val tflite = testTF.getTfliteInterpreter("test_model1.tflite")
//        val ASSOCIATED_AXIS_LABELS = "test_label.txt"
//        var associatedAxisLabels = null
//
//        try{
...
//        var outputs : Array<FloatArray> = arrayOf((floatArrayOf(0.0f, 0.0f)))
//    }
}
